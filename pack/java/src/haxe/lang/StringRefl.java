...
public  class StringRefl
{
	...
	{
		{
			java.lang.String __temp_svar74 = (f);
			int __temp_hash76 = __temp_svar74.hashCode();
			boolean __temp_executeDef75 = true;
			switch (__temp_hash76)
			{
				case -1106363674:
				{
					if (__temp_svar74.equals("length")) 
					{
				...
				{
					if (( (( ( __temp_hash76 == 530542161 ) && __temp_svar74.equals("substring") )) || ( (( ( __temp_hash76 == -891529231 ) && __temp_svar74.equals("substr") )) || ( (( ( __temp_hash76 == 109648666 ) && __temp_svar74.equals("split") )) || ( (( ( __temp_hash76 == -467511597 ) && __temp_svar74.equals("lastIndexOf") )) || ( (( ( __temp_hash76 == 1943291465 ) && __temp_svar74.equals("indexOf") )) || ( (( ( __temp_hash76 == 397153782 ) && __temp_svar74.equals("charCodeAt") )) || ( (( ( __temp_hash76 == -1361633751 ) && __temp_svar74.equals("charAt") )) || ( (( ( __temp_hash76 == -1137582698 ) && __temp_svar74.equals("toLowerCase") )) || __temp_svar74.equals("toUpperCase") ) ) ) ) ) ) ) )) 
					{
						__temp_executeDef75 = false;
