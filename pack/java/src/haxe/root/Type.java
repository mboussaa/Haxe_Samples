...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   void __hx_ctor__Type(haxe.root.Type __temp_me13)
	{
		{
		}
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar57 = (name);
			int __temp_hash59 = __temp_svar57.hashCode();
			boolean __temp_executeDef58 = true;
			switch (__temp_hash59)
			{
				case -672261858:case 104431:
				{
					if (( (( ( __temp_hash59 == -672261858 ) && __temp_svar57.equals("Integer") )) || __temp_svar57.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar57.equals("Object")) 
					{
						__temp_executeDef58 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash59 == 2052876273 ) && __temp_svar57.equals("Double") )) || __temp_svar57.equals("double") )) 
					{
						__temp_executeDef58 = false;
						return "Float";
					}
