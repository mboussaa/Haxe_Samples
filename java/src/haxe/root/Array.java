...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	{
		{
			boolean __temp_executeDef18 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef20 = true;
			switch (field.hashCode())
			{
				case -1106363674:
				{
	...
	{
		{
			boolean __temp_executeDef21 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
