...
public  class Type extends haxe.lang.HxObject
{
	...
	public static   java.lang.String getClassName(java.lang.Class c)
	{
		...
		{
			java.lang.String __temp_svar33 = (name);
			int __temp_hash35 = __temp_svar33.hashCode();
			boolean __temp_executeDef34 = true;
			switch (__temp_hash35)
			{
				case -672261858:case 104431:
				{
					if (( (( ( __temp_hash35 == -672261858 ) && __temp_svar33.equals("Integer") )) || __temp_svar33.equals("int") )) 
					{
				...
				case -1939501217:
				{
					if (__temp_svar33.equals("Object")) 
					{
						__temp_executeDef34 = false;
						return "Dynamic";
					}
				...
				{
					if (( (( ( __temp_hash35 == 2052876273 ) && __temp_svar33.equals("Double") )) || __temp_svar33.equals("double") )) 
					{
						__temp_executeDef34 = false;
						return "Float";
					}
