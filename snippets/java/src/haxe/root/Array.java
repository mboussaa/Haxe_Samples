...
public final class Array<T> extends haxe.lang.HxObject
{
	...
	{
		{
			boolean __temp_executeDef23 = true;
			switch (field.hashCode())
			{
				case 94337:
				{
	...
	{
		{
			boolean __temp_executeDef24 = true;
			switch (field.hashCode())
			{
				case -537840087:
				{
