...
public  class Std
{
	...
	public static   boolean is(java.lang.Object v, java.lang.Object t)
	{
		...
		{
			java.lang.String __temp_svar39 = (name);
			int __temp_hash41 = __temp_svar39.hashCode();
			switch (__temp_hash41)
			{
				case 761287205:case -1325958191:
				{
					if (( (( ( __temp_hash41 == 761287205 ) && __temp_svar39.equals("java.lang.Double") )) || __temp_svar39.equals("double") )) 
					{
				...
				case 1063877011:
				{
					if (__temp_svar39.equals("java.lang.Object")) 
					{
						return true;
					}
				...
				{
					if (( (( ( __temp_hash41 == -2056817302 ) && __temp_svar39.equals("java.lang.Integer") )) || __temp_svar39.equals("int") )) 
					{
				...
				{
					if (( (( ( __temp_hash41 == 344809556 ) && __temp_svar39.equals("java.lang.Boolean") )) || __temp_svar39.equals("boolean") )) 
					{
